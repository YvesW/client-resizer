...
public class ClientResizerPlugin extends Plugin {
    ...
    private Dimension autoSize2Dimension;
    private MonitorAttribute autoSize2Attribute;
    private String autoSize2Value;
    private Dimension autoSize3Dimension;
    private MonitorAttribute autoSize3Attribute;
    private String autoSize3Value;
    private Dimension autoSize4Dimension;
    private MonitorAttribute autoSize4Attribute;
    private String autoSize4Value;
    private Dimension autoSize5Dimension;
    private MonitorAttribute autoSize5Attribute;
    private String autoSize5Value;
    private Dimension autoSize6Dimension;
    private MonitorAttribute autoSize6Attribute;
    private String autoSize6Value;
    private Dimension autoSize7Dimension;
    private MonitorAttribute autoSize7Attribute;
    private String autoSize7Value;
    private Dimension autoSize8Dimension;
    private MonitorAttribute autoSize8Attribute;
    private String autoSize8Value;
    private Dimension autoSize9Dimension;
    private MonitorAttribute autoSize9Attribute;
    private String autoSize9Value;
    private Dimension autoSize10Dimension;
    private MonitorAttribute autoSize10Attribute;
    private String autoSize10Value;
    private Dimension hotkey1Dimension;
    private Keybind hotkey1Key;
    private Dimension hotkey2Dimension;
    private Keybind hotkey2Key;
    private Dimension hotkey3Dimension;
    private Keybind hotkey3Key;
    private Dimension hotkey4Dimension;
    private Keybind hotkey4Key;
    private Dimension hotkey5Dimension;
    private Keybind hotkey5Key;
    private Dimension hotkey6Dimension;
    private Keybind hotkey6Key;
    private Dimension hotkey7Dimension;
    private Keybind hotkey7Key;
    private Dimension hotkey8Dimension;
    private Keybind hotkey8Key;
    private Dimension hotkey9Dimension;
    private Keybind hotkey9Key;
    private Dimension hotkey10Dimension;
    private Keybind hotkey10Key;
    private MonitorAttribute copyAttribute;
